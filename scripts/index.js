...
// 	e.preventDefault();
// 	var $input = $form.find('.moodInput');
// 	var value = $input.val();
// 	console.log(value);
// });
// TO DO- why does this work???
// add to cloud, then match with a mood function
...
// TO DO- change to JQUERY?
// let moodInput = document.getElementById(‘trackInput’);
...
// // TO DO- try to do this using a for loop instead
...
// // BLOTTER - Example 2
// var text = new Blotter.Text("MOOD", {
